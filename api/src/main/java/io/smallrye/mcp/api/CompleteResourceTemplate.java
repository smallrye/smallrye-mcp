...
/**
 * Annotates a business method of a bean used to complete an expression of a URI template of a resource template.
 * <p>
 * The result of a "complete" operation is always represented as a {@link CompletionResponse}.
 ...
 * <li>{@code CompletableStage<CompletionResponse>}</li>
 * <li>{@code CompletableStage<String>}</li>
 * <li>{@code CompletableStage<List<String>>}</li>
